...
0. **Постановка задачи и анализ возможных сценариев**
   Предполагалось, что патогенный организм в образце является бактерией или вирусом (как наиболее вероятные варианты). В этом случае его геном должен быть относительно небольшим и достаточно простым для анализа.
...
Для поиска факторов патогенности аннотированные гены были сопоставлены с базой данных VFDB. В результате было обнаружено 20 потенциальных факторов патогенности.
