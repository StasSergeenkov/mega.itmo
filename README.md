...
В проанализированном геноме нам не удалось обнаружить гены, кодирующие ботулотоксин типа B. Нам удалось обнаружить ботулинический нейротоксин подтипа F6 _(pgaptmp_000640: "botulinum neurotoxin subtype F6")_, что может говорить о том, что <ins>анализируемый нами штамм</ins> не является эталонным.
