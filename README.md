...
2. Идентификация организма
   - С применением Core nucleotide database (core nt). Для доступа к базе данных, в силу ограничений веб-версии BLAST NCBI в 1 мегабаз, использовался онлайн сервис BV-BRC.
...
Выполнялся с применением онлайн
