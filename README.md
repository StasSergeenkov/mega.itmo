...
В проанализированном геноме нам не удалось обнаружить гены, кодирующие ботулотоксин типа B. Нам удалось обнаружить ботулинический нейротоксин подтипа F6 и E10 _(pgaptmp_000640: "botulinum neurotoxin subtype F6", pgaptmp_000185: "botulinum neurotoxin subtype E10")_, что может говорить о том, что <ins>анализируемый нами штамм</ins> относит ко второй группе по геномной классификации и продуцирует непроетолитические психотрофные токсины групп B, E и F.
